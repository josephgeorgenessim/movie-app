        ...
        {moviesLoading || trendingMoviesLoading ?
          ...
          : moviesError || trendingMoviesError ? (
            ...
            <View className=" mt-10">
              <SearchBar onPress={() => router.push('/search')} placeholder="Search for a movie, series or person" />
              {trendingMovies && trendingMovies.length > 0 && (
                <>
                  <Text className="text-lg text-white font-bold mt-5">Trending Movies</Text>
                  <FlatList
                    horizontal
